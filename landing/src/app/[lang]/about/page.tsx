    ...
    <div className="min-h-screen bg-white text-left overflow-x-hidden font-sans selection:bg-blue-600 selection:text-white">
          ...
          <div className="hidden md:flex items-center gap-10">
            {[
              ...
              <Link
                key={item.name}
                href={item.href}
                className={`text-sm font-medium transition-colors ${item.href.includes("/about") ? "text-blue-600" : "text-slate-600 hover:text-blue-600"}`}
              >
                {item.name}
              </Link>
            ))}
      ...
      <section className="py-16 px-5 sm:px-6 bg-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto">
          <motion.p
            {...fadeInUp}
            className="text-center text-xs font-black uppercase tracking-widest text-slate-400 mb-10"
          >
            {a.statsLabel}
          </motion.p>
            ...
            {a.values.map((v, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group p-8 rounded-3xl border border-slate-100 hover:border-blue-100 hover:shadow-xl transition-all bg-white"
                >
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <motion.div {...fadeInUp}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => setIsLeadModalOpen(true)}
                className="group px-8 py-4 bg-white text-blue-600 font-bold rounded-2xl hover:bg-blue-50 transition-all active:scale-[0.97] shadow-xl flex items-center justify-center gap-3"
              >
                {a.ctaBtn}{" "}
              ...
              <Link
                href={`/${params.lang}`}
                className="px-8 py-4 bg-white/10 border border-white/20 text-white font-bold rounded-2xl hover:bg-white/20 transition-all active:scale-[0.97] flex items-center justify-center gap-2"
              >
                {t.nav.features}
              </Link>
            </div>
