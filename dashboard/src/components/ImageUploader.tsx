...
export default function ImageUploader({ value, onChange, onRemove, label = 'Upload Image', className }: ImageUploaderProps) {
        ...
        {uploading ? (
          ...
          <>
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">PNG, JPG, GIF up to 5MB · Drag & drop or click</p>
            </div>
          </>
        )}
      </div>
