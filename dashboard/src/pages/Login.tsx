...
import { Lock, Phone, Loader2, ArrowRight, ShieldCheck, Sun, Moon } from 'lucide-react';
...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = (err as { response?: { data?: { message?: string } } })?.response?.data?.message || 'Authentication failed. Please check credentials.';
          ...
          <>
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">{t.forgotTitle}</h3>
