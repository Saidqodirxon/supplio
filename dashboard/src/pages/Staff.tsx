...
const T = {
  ...
  roleNamePlaceholder: {
    uz: "Masalan: Hisobchi, Filial menejer, Kuryer...",
    ru: "Например: Бухгалтер, Менеджер филиала...",
    tr: "Örn: Muhasebeci, Şube müdürü...",
    oz: "Масалан: Ҳисобчи, Филиал менежер...",
    en: "e.g. Accountant, Branch Manager, Courier...",
  },
  permissions: {
    uz: "Ruxsatlar",
    ru: "Разрешения",
  ...
  clearAll: {
    ...
    ru: "Снять все",
    tr: "Hepsini temizle",
    oz: "Ҳаммасини тозалаш",
    en: "Clear all",
  },
  noRoles: {
    uz: "Maxsus rollar yo'q",
    ru: "Нет пользовательских ролей",
    tr: "Özel rol yok",
    oz: "Махсус роллар йўқ",
    en: "No custom roles yet",
  },
  noRolesDesc: {
    uz: "Yangi rol yarating va xodimlarga biriktiring",
    ru: "Создайте роль и назначьте сотрудникам",
    tr: "Rol oluşturun ve personele atayın",
    oz: "Янги рол яратинг ва ходимларга бириктиринг",
    en: "Create a role and assign it to staff",
  },
  addRole: {
    uz: "Rol qo'shish",
    ru: "Добавить роль",
  ...
  deleteRoleDesc: {
    uz: "Bu rol hech bir xodimga biriktirilmagan. O'chirishni tasdiqlaysizmi?",
    ru: "Эта роль не назначена ни одному сотруднику. Подтверждаете удаление?",
    tr: "Bu rol hiç bir personele atanmamış. Silmeyi onaylıyor musunuz?",
    oz: "Бу рол ҳеч бир ходимга бириктирилмаган. Ўчиришни тасдиқлайсизми?",
    en: "This role has no users assigned. Confirm deletion?",
  },
  fullName: {
    uz: "To'liq ism",
    ru: "Полное имя",
  ...
  selectCustomRole: {
    uz: "Maxsus rolni tanlang",
    ru: "Выберите пользовательскую роль",
    tr: "Özel rol seçin",
    oz: "Махсус ролни танланг",
    en: "Select custom role",
  },
  branch: {
    uz: "Filial",
    ru: "Филиал",
  ...
  removeStaffDesc: {
    uz: "Bu xodim tizimdan o'chiriladi. Tasdiqlaysizmi?",
    ru: "Этот сотрудник будет удалён из системы. Подтвердите.",
    tr: "Bu personel sistemden silinecek. Onaylıyor musunuz?",
    oz: "Бу ходим тизимдан ўчирилади. Тасдиқлайсизми?",
    en: "This staff member will be removed from the system. Confirm?",
  },
  editStaff: {
    uz: "Xodimni tahrirlash",
    ru: "Редактировать сотрудника",
    tr: "Personeli düzenle",
    oz: "Ходимни таҳрирлаш",
    en: "Edit staff",
  },
  save: {
    uz: "Saqlash",
  ...
  permissionsPreview: {
    uz: "Ruxsatlar ro'yxati",
    ru: "Список разрешений",
    tr: "İzin listesi",
    oz: "Рухсатлар рўйхати",
    en: "Permissions list",
  },
  noPermissions: {
    uz: "Ruxsatlar belgilanmagan",
    ru: "Разрешения не указаны",
    tr: "İzin belirtilmemiş",
    oz: "Рухсатлар белгиланмаган",
    en: "No permissions set",
  },
  error: {
...
const PERMISSION_GROUPS: {
  ...
  },
  {
    ...
    keys: ["viewPayments", "createPayments"],
  },
  {
    groupKey: "dealers",
    group: {
    ...
    keys: ["viewDealers", "createDealers"],
  },
  {
    groupKey: "products",
    group: {
  ...
  },
  {
    ...
    keys: ["viewExpenses", "createExpenses"],
  },
  {
    groupKey: "other",
    group: {
    ...
    keys: ["viewAnalytics", "viewBranches", "manageBranches"],
  },
];
...
export default function Staff() {
  ...
  const { showUpgrade, setShowUpgrade, upgradeReason, handleApiError } =
    usePlanLimits();
  ...
  const visibleStaff = useMemo(() => {
    let list = staff.filter(
      (s) => s.roleType !== "OWNER" && s.roleType !== "SUPER_ADMIN"
    );
    if (search.trim()) {
  ...
  const handleAddStaff = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!staffForm.phone || !staffForm.password || !staffForm.fullName)
      return toast.error(tx("error", lang));
    try {
      setSaving(true);
  ...
  const getEnabledPermissions = (permissions: Record<string, boolean>) =>
    Object.entries(permissions)
      .filter(([, v]) => !!v)
      .map(([k]) => (PERMISSION_LABELS[lang] ?? PERMISSION_LABELS.en)[k] || k);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-100 dark:border-slate-800">
        <div>
          ...
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-2">
            {visibleStaff.length} {tx("members", lang)} · {customRoles.length}{" "}
            {tx("customRoles", lang)}
          </p>
        </div>
        {canManage && (
                ...
                <div className="border-t border-slate-100 dark:border-white/5">
                  {customRoles.length === 0 ? (
                    ...
                    <div className="divide-y divide-slate-50 dark:divide-white/5">
                      {customRoles.map((cr) => {
                        const perms = getEnabledPermissions(
                          cr.permissions as Record<string, boolean>
                        );
                        return (
                          <div
                            key={cr.id}
                            className="flex items-start justify-between px-5 py-4 hover:bg-slate-50/50 dark:hover:bg-white/5 transition-all gap-4"
                          >
                              ...
                              {perms.length > 0 ? (
                                <div className="flex flex-wrap gap-1">
                                  {perms.map((p) => (
                                    <span
                                      key={p}
                                      className="text-[10px] text-slate-500 dark:text-slate-400 font-medium bg-slate-100 dark:bg-slate-800 px-2 py-0.5 rounded-md"
                                    >
                                      {p}
                                    </span>
                                  ))}
      ...
      <AnimatePresence>
        {showAddStaff && (
          <motion.div
            ...
            onClick={(e) => {
              if (e.target === e.currentTarget) setShowAddStaff(false);
            }}
          >
            <motion.div
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-2">
                    {BUILT_IN_ROLES.map((r) => (
                      ...
                      >
                        {BUILTIN_ROLE_LABELS[r]?.[lang] ??
                          BUILTIN_ROLE_LABELS[r]?.en ??
                          r}
                      </button>
                    ))}
                  </div>
                  ...
                  {customRoles.length > 0 && (
                    <>
                      ...
                      <div className="space-y-1.5">
                        {customRoles.map((cr) => {
                          const isSelected =
                            staffForm.roleType === "CUSTOM" &&
                            staffForm.customRoleId === cr.id;
                          const perms = getEnabledPermissions(
                            cr.permissions as Record<string, boolean>
                          );
                          return (
                    ...
                    <div className="space-y-1">
                      {[
                        ...
                        <button
                          ...
                          type="button"
                          onClick={() =>
                            setStaffForm((f) => ({ ...f, branchId: b.id }))
                          }
                          className={clsx(
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    type="button"
                    onClick={() => setShowAddStaff(false)}
                    className="flex-1 px-5 py-3 rounded-xl border border-slate-200 dark:border-slate-700 font-black text-[10px] uppercase tracking-widest hover:bg-slate-50 dark:hover:bg-slate-800 transition-all text-slate-600 dark:text-slate-300"
                  >
                    {tx("cancel", lang)}
                  </button>
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-5 py-3 rounded-xl bg-blue-600 text-white font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 transition-all disabled:opacity-50 shadow-lg shadow-blue-600/20"
                  >
          ...
          (() => {
            ...
            return (
              <motion.div
                ...
                className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm"
                onClick={(e) => {
                  if (e.target === e.currentTarget) setEditStaffId(null);
                }}
              >
                <motion.div
                  initial={{ scale: 0.95, y: 16 }}
                  ...
                  >
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-2">
                        {BUILT_IN_ROLES.map((r) => (
                          <button
                            ...
                            className={clsx(
                              "px-3 py-2.5 rounded-xl border text-xs font-black transition-all",
                              editForm.roleType === r
                                ? "border-blue-600 bg-blue-600 text-white"
                      ...
                      {customRoles.length > 0 && (
                        <>
                          ...
                          <div className="space-y-1.5">
                            {customRoles.map((cr) => {
                              const isSelected =
                                editForm.roleType === "CUSTOM" &&
                                editForm.customRoleId === cr.id;
                              return (
                                <button
                                  key={cr.id}
                                  type="button"
                        ...
                        <div className="space-y-1">
                          {[
                            ...
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                setEditForm((f) => ({ ...f, branchId: b.id }))
                              }
                              className={clsx(
                                "w-full text-left px-4 py-2.5 rounded-xl border text-xs font-semibold transition-all",
                                editForm.branchId === b.id
                                  ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400"
                    ...
                    <div className="flex gap-3 pt-2">
                      ...
                      <button
                        type="submit"
                        disabled={saving}
                        className="flex-1 px-5 py-3 rounded-xl bg-blue-600 text-white font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 transition-all disabled:opacity-50"
                      >
                        {saving ? tx("saving", lang) : tx("save", lang)}
                      </button>
                    </div>
      ...
      <AnimatePresence>
        {showRoleManager && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm"
            onClick={(e) => {
              if (e.target === e.currentTarget) closeRoleManager();
            }}
          >
            <motion.div
              initial={{ scale: 0.95, y: 16 }}
              ...
              >
                    ...
                    {PERMISSION_GROUPS.map((group) => (
                      <div key={group.groupKey}>
                        <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">
                          {(group.group as Record<string, string>)[lang] ??
                            group.group.en}
                        </p>
                        <div className="space-y-1.5">
                          {group.keys.map((key) => {
                            const label =
                              (PERMISSION_LABELS[lang] ?? PERMISSION_LABELS.en)[
                                key
                              ] || key;
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 px-5 py-3 rounded-xl bg-indigo-600 text-white font-black text-[10px] uppercase tracking-widest hover:bg-indigo-700 transition-all disabled:opacity-50 shadow-lg shadow-indigo-600/20"
                  >
                    {saving ? tx("saving", lang) : tx("save", lang)}
                  </button>
                </div>
            ...
            >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-5 py-3 rounded-xl bg-rose-600 text-white font-black text-[10px] uppercase tracking-widest hover:bg-rose-700 transition-all"
                >
                  {tx("confirm", lang)}
                </button>
              </div>
      ...
      <AnimatePresence>
        {deleteRoleId && (
          <motion.div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm"
            onClick={(e) => {
              if (e.target === e.currentTarget) setDeleteRoleId(null);
            }}
          >
            <motion.div
              initial={{ scale: 0.95 }}
