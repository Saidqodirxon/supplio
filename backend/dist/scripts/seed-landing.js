...
async function main() {
    ...
    await prisma.systemSettings.create({
        data: {
            ...
            defaultTrialDays: 14,
            systemVersion: "2.1.0",
            globalNotifyUz: "Supplio V2 tarmog'i ishga tushirildi! Barcha dilerlar uchun yangi imkoniyatlar.",
            globalNotifyRu: "Сеть Supplio V2 запущена! Новые возможности для всех дилеров.",
            globalNotifyEn: "Supplio V2 network is live! New features for all dealers.",
            globalNotifyTr: "Supplio V2 ağı yayında! Tüm bayiler için yeni özellikler.",
        },
    });
    const tariffs = [
        {
    ...
    const news = [
        {
            ...
            excerptUz: "Markaziy Osiyodagi B2B distribyutorlar uchun eng kuchli tizim.",
            excerptUzCyr: "Марказий Осиёдаги B2B дистрибьюторлар учун энг кучли тизим.",
            excerptRu: "Самая мощная система для B2B-дистрибьюторов в Центральной Азии.",
            excerptEn: "The most powerful system for B2B distributors in Central Asia.",
        ...
        },
        {
            ...
            contentUz: "Telegram botlari dilerlar uchun qulay interfeys taqdim etadi.",
            contentUzCyr: "Telegram ботлари дилерлар учун қулай интерфейс тақдим этади.",
...
//# sourceMappingURL=seed-landing.js.map