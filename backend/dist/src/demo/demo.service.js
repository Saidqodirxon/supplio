...
let DemoService = DemoService_1 = class DemoService {
    ...
    async handleDailyReset() {
        this.logger.log("CRON: Starting Demo Environment Reset (every 3 days)...");
    ...
    async resetCompanyData(companyId) {
        ...
        const orderItems = (name, qty, price) => JSON.stringify([
        ...
        return [
            {
                ...
                excerptTr: "Orta Asya'daki B2B distribütörleri için yapılmış en güçlü kredi kontrol sistemi burada.",
                excerptUzCyr: "Марказий Осиёдаги B2B дистрибуторлар учун энг кучли кредит-назорат тизими тайёр.",
                ...
                contentTr: "Supplio'yu sıfırdan yeniden tasarladık. Yeni versiyonda gerçek zamanlı defter senkronizasyonu ve anlık kredi doğrulaması bulunuyor.",
                contentUzCyr: "Биз Supplio-ни бутунлай қайтадан яратдик. Янги версияда реал вақт синхронизацияси ва тезкор кредит текшируви мавжуд.",
            ...
            },
            {
                ...
                excerptRu: "Всё больше дистрибьюторов заменяют традиционные приложения на системы заказов через Telegram.",
                excerptTr: "Giderek daha fazla distribütör geleneksel uygulamalardan Telegram tabanlı sipariş sistemlerine geçiyor.",
                excerptUzCyr: "Кўпроқ дистрибуторлар анъанавий иловалардан Telegram асосидаги буюртма тизимларига ўтмоқда.",
                ...
                contentUz: "Telegram endi shunchaki messenger emas — bu biznes operatsion tizimiga aylanmoqda.",
                contentRu: "Telegram — это уже не просто мессенджер, а полноценная бизнес-операционная система.",
                contentTr: "Telegram artık sadece bir mesajlaşma uygulaması değil — bir iş işletim sistemi haline geliyor.",
                contentUzCyr: "Telegram энди шунчаки messenger эмас — бу бизнес операцион тизимига айланмоқда.",
            ...
            },
            {
                ...
                excerptEn: "How leading distributors use real-time credit tracking to reduce bad debt by up to 40%.",
                excerptUz: "Yetakchi distribyutorlar qanday qilib real vaqt kredit kuzatuvidan foydalanib, yomon qarzni 40% gacha kamaytirmoqda.",
                excerptRu: "Как ведущие дистрибьюторы используют отслеживание кредитов в реальном времени для снижения безнадёжных долгов на 40%.",
                excerptTr: "Önde gelen distribütörler, gerçek zamanlı kredi takibini kullanarak kötü borçları %40'a kadar nasıl azaltıyor.",
                excerptUzCyr: "Yetakchi distribuçiyachi kompaniyalar qanday qilib real vaqt kredit kuzatuvidan foydalanib yomon qarzni 40% gacha kamaytirmoqda.",
                contentEn: "Effective credit management is the backbone of successful distribution. Companies using automated credit limit enforcement see dramatic reductions in overdue accounts.\n\nSupplio's real-time credit tracking automatically blocks orders that would exceed a dealer's limit, alerting both the dealer and your team instantly.",
                contentUz: "Samarali kredit boshqaruvi muvaffaqiyatli distribyutsiyaning asosini tashkil etadi.",
                contentRu: "Эффективное управление кредитами является основой успешного дистрибьюторства.",
                contentTr: "Etkili kredi yönetimi, başarılı dağıtımın temelidir.",
                contentUzCyr: "Samarali kredit boshqaruvi muvaffaqiyatli distribyuçiyaning asosini tashkil etadi.",
            ...
            },
            {
                ...
                excerptEn: "Every Supplio plan now includes a branded web store where dealers can browse your catalog and place orders anytime.",
                excerptUz: "Har bir Supplio tarifi endi brendlangan veb-do'konni o'z ichiga oladi.",
                excerptRu: "Каждый тариф Supplio теперь включает брендированный веб-магазин для заказов.",
                excerptTr: "Her Supplio planı artık markalı bir web mağazası içeriyor.",
                excerptUzCyr: "Har bir Supplio tarifi endi brendlangan veb-do'konni o'z ichiga oladi.",
                contentEn: "The Supplio Web Store is a public-facing storefront automatically generated from your product catalog. Dealers can browse products, check prices, and place orders directly — without needing the Telegram bot.\n\nEvery store comes with your company branding, product images, and is accessible at your unique URL.",
                contentUz: "Supplio veb-do'koni mahsulot katalogingizdan avtomatik yaratilgan ommaviy vitrinadir.",
                contentRu: "Веб-магазин Supplio — это публичный витрина, автоматически созданная из вашего каталога продуктов.",
                contentTr: "Supplio Web Mağazası, ürün kataloğunuzdan otomatik olarak oluşturulan genel bir vitrindır.",
                contentUzCyr: "Supplio veb-do'koni mahsulot katalogingizdan avtomatik yaratilgan ommaviy vitrinadir.",
            ...
            },
            {
                ...
                excerptEn: "The redesigned analytics dashboard gives managers a complete picture of dealer performance, revenue trends, and credit risk in real time.",
                excerptUz: "Qayta ishlangan analitika paneli menejerlarga diler faoliyati, daromad tendensiyalari va kredit riskini real vaqtda ko'rish imkonini beradi.",
                excerptRu: "Обновлённая аналитическая панель даёт менеджерам полную картину эффективности дилеров, тенденций выручки и кредитных рисков в реальном времени.",
                excerptTr: "Yeniden tasarlanan analitik pano, yöneticilere bayi performansı, gelir eğilimleri ve kredi riskini gerçek zamanlı olarak görme imkânı tanıyor.",
                excerptUzCyr: "Qayta ishlangan analitika paneli menejerlarga real vaqtda diler faoliyati va kredit riskini ko'rish imkonini beradi.",
                contentEn: "Understanding your distribution network's health has never been easier. The new analytics dashboard consolidates data from all your branches and dealers into one powerful view.\n\nTrack top performers, identify at-risk dealers, and monitor revenue trends by branch, product, or time period.",
                contentUz: "Distribyutsiya tarmog'ingiz holatini tushunish hech qachon bunday oson bo'lmagan.",
                contentRu: "Понимание состояния вашей сети дистрибуции ещё никогда не было таким простым.",
                contentTr: "Dağıtım ağınızın durumunu anlamak hiç bu kadar kolay olmamıştı.",
                contentUzCyr: "Distribyuçiya tarmog'ingiz holatini tushunish hech qachon bunday oson bo'lmagan.",
        ...
        return [
            {
                ...
                description: "Premium food and beverage distributor serving Central Asia",
...
], DemoService.prototype, "handleDailyReset", null);
